        ...
        <div
          ...
          {canEdit && !isEditing && (
            <button
              ...
              title="Edit message"
              className="text-theme-text-muted hover:text-theme-text absolute top-full right-0 mt-1 rounded-lg p-1 opacity-0 transition-opacity duration-75 group-hover:opacity-100 focus-visible:opacity-100">
              <Pencil size={16} />
            </button>
          )}
        </div>
